...
return [
    'home' => [
        ...
        'fields' => [
            ...
            'why_title' => 'Safe, reliable &amp; genuinely comfortable',
            'why_sub' => 'The promises we keep on every single trip — for your peace of mind, comfort and budget.',
            'services_title' => 'One trusted cab partner for every journey',
            'routes_title' => 'Top Jaipur taxi routes at transparent fares',
            'routes_sub' => 'Fixed prices for the trips our riders book most — only parking extra. Tap any route for details.',
            'ratetable_title' => 'One-way taxi fares at a glance',
            'ratetable_sub' => 'Fixed one-way fares for every route — only parking extra.',
            'estimator_title' => 'Estimate your cab fare in seconds',
            'estimator_sub' => 'Pick a route or enter the distance and car type for a clear estimate — then book it on WhatsApp.',
            'steps_title' => 'Booking a cab has never been this easy',
            'fleet_title' => 'Choose the right cab for your journey',
            'fleet_sub' => 'From economical sedans to spacious tempo travellers — all clean, AC and driver-included.',
            'reviews_title' => 'Trusted by travellers across Rajasthan',
            'faq_title' => 'MK Cab Service — your questions answered',
            'cta_title' => 'Ready to ride? Your cab is a tap away',
            'cta_sub' => 'Book in under a minute. Honest fares, clean cars, courteous drivers — 24x7 across Jaipur and all of Rajasthan.',
        ],
        'field_labels' => [
            'why_title' => '"Why choose us" section — heading',
            'why_sub' => '"Why choose us" section — description',
            'services_title' => 'Services section — heading',
            'routes_title' => 'Popular routes section — heading',
            'routes_sub' => 'Popular routes section — description',
            'ratetable_title' => 'Rate table section — heading',
            'ratetable_sub' => 'Rate table section — description',
            'estimator_title' => 'Fare estimator section — heading',
            'estimator_sub' => 'Fare estimator section — description',
            'steps_title' => '"How it works" section — heading',
            'fleet_title' => 'Fleet section — heading',
            'fleet_sub' => 'Fleet section — description',
            'reviews_title' => 'Reviews section — heading',
            'faq_title' => 'FAQ section — heading',
            'cta_title' => 'Bottom CTA — heading',
            'cta_sub' => 'Bottom CTA — description',
        ],
    ],
    'about' => [
        'label' => 'About Us',
